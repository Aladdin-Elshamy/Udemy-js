...
function Slider() {
    ...
    // }, [currentSlide]); // سيعمل عندما تتغير قيمة currentSlide
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            dispatch(nextSlide());
        }, 3000); // تغيير الرقم لتحديد سرعة السلايدر (3000 مللي ثانية = 3 ثواني)

        return () => clearInterval(interval); // تنظيف الـ interval عند إلغاء التركيب
    }, [dispatch]);
